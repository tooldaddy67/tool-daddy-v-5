...
export default function MacGenerator() {
    ...
    const generate = () => {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            // Ensure first byte is local/unicast if needed, but for general random just random is fine
            // except we should avoid multicast bits for general usage
            if (i === 0) {
                // Set bit 1 to 0 (Unicast) and bit 2 (Locally Administered)
