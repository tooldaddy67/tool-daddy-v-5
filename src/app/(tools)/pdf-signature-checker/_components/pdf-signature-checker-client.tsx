...
import { FileBadge, Upload, ShieldCheck, Info, CheckCircle2, XCircle, FileText, Loader2 } from 'lucide-react';
    ...
    const checkPdf = async (file: File) => {
        ...
        try {
            ...
            if (acroForm) {
                ...
                const text = new TextDecoder().decode(rawBuffer.slice(0, 1000000));
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in duration-500">
                    ...
                    <div className="md:col-span-3">
                        <div className="p-4 rounded-xl bg-primary/5 border border-primary/20 flex gap-3 text-xs text-muted-foreground leading-relaxed">
                            ...
                            <p>
                                **Note on Verification:** This tool performs a structural analysis to detect the presence of digital signatures. To verify the cryptographic identity of the signers, please use a dedicated tool like Adobe Acrobat.
                            </p>
                        </div>
                    </div>
                </div>
