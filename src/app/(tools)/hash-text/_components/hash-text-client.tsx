...
export default function HashTextClient() {
    ...
    const computeHash = async () => {
        ...
        try {
            ...
            toast({
                title: 'Hashing Error',
                description: 'Failed to compute hash. Ensure the algorithm is supported by your browser.',
                variant: 'destructive',
            });
            setResult('Error: Algorithm likely not supported by your browser native Web Crypto API.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="container mx-auto py-10 px-4 max-w-4xl">
            <div className="flex flex-col items-center mb-10 text-center">
                ...
                <p className="text-muted-foreground">Generate cryptographic hashes using your browser native Web Crypto API.</p>
            </div>
