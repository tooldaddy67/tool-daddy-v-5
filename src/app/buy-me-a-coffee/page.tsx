      ...
      <div className="w-full max-w-4xl mx-auto p-4 md:p-8">
        <Card className="bg-card/50 backdrop-blur-lg border-border/20">
          <CardHeader>
            ...
            <CardDescription>
              Please wait while we redirect you to our support page. Thanks for your consideration!
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex justify-center items-center h-64 border-2 border-dashed rounded-lg bg-background/30">
              <div className="text-center">
                ...
                <p className="mt-4 text-muted-foreground">Preparing our support page...</p>
              </div>
            </div>
          </CardContent>
        </Card>
